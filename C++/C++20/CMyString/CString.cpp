...
int CString::class_num = 0;
CString::CString(const char* sz):m_sz(nullptr), m_pnRef(nullptr), m_nBufSize(0), id(class_num++)
{
	Init(sz);
}

CString::CString(const CString& obj): m_sz(nullptr), m_pnRef(nullptr), m_nBufSize(0), id(class_num++)
{
	m_sz = obj.m_sz;
