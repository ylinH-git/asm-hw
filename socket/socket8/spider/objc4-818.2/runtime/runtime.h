 ...
 *  implemented by the class¡ªany instance methods implemented by superclasses are not included. 
 ...
 * @param imp A function which is the implementation of the new method. The function must take at least two arguments¡ªself and _cmd.
 ...
 * @param types An array of characters that describe the types of the arguments to the method. 
 *  Since the function must take at least two arguments¡ªself and _cmd, the second and third characters
